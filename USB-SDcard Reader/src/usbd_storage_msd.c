...
const int8_t  STORAGE_Inquirydata[] = {//36
  ...
  /* LUN 0 */
  0x00,																		/* 0x00 - flash, 0x05 - cd */
  0x80,																		/* Has removable memory	 */
  0x04,		
  0x02,
  ...
  0x00,	
  0x00,
  'G', 'r', 'z', 'e', 's', 'R', 'O', 'X', /* Manufacturer : 8 bytes */
                 ...
                 uint16_t blk_len)
{
  ...
  if( MSD_ReadMultiBlock (blk_addr, 
                          buf, 
                          blk_len) != 0)
  {
    return -1;
                  ...
                  uint16_t blk_len)
{
  ...
  if( MSD_WriteMultiBlock (blk_addr, 
                           buf, 
                           blk_len) != 0)
  {
    return -1;
