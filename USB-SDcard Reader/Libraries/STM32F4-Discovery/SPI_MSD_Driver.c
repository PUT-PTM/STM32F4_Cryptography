...
** Version:
** Descriptions:						Modified to work with stm32F4 and USB MSD (tested on STM32F4-Discovery board)
**
*********************************************************************************************************/
...
void MSD_SPI_Configuration(void)
{
	...
	*/
	...
	/* Connect SCK, MISO, MOSI pins to SPI alternate function */
