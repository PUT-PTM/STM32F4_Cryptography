...
**
**--------------------------------------------------------------------------------------------------------
** Modified by:							Grzegorz Juszczak
** Modified date:						2014-4-5
** Version:
** Descriptions:						Modified to work with stm32F4 and USB MSD
**
*********************************************************************************************************/
...
#define _CARD_ENABLE()				GPIO_ResetBits(SD_CS_GPIO_PORT, SD_CS_PIN)
#define _CARD_DISABLE()				GPIO_SetBits(SD_CS_GPIO_PORT, SD_CS_PIN)
#define _CARD_POWER_ON()

/* Card detection can be disabled by replacing below line with #define _NO_CARD_INSERT() 0 */
#define _NO_CARD_INSERT()			GPIO_ReadInputDataBit(SD_DETECT_GPIO_PORT, SD_DETECT_PIN)
