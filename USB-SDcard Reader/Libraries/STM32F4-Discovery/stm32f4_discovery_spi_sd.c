/**
  ******************************************************************************
  * @file    stm32f4_discovery_spi_sd.c
  * @author  MCD Application Team modified by Grzegorz J.
  * @version V5.0.2
  * @date    09-March-2012
  * @brief   This file originaly was stm32l152_eval_spi_sd.c. It was modified
	*					 to work with stm32f4 discovery board.
	*						
	*					 This file provides a set of functions needed to manage the SPI SD 
...
/* Includes ------------------------------------------------------------------*/
#include "stm32f4_discovery_spi_sd.h"
...
{
	//a bit :P modified by Grzegorz Juszczak
	return SD_PRESENT; // always present ;)
